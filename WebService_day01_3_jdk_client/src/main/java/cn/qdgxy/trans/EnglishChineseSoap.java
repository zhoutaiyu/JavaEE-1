...
public interface EnglishChineseSoap {
     ...
     *
     * @param wordKey
     * @return returns cn.qdgxy.trans.TranslatorResponse.TranslatorResult
     */
    ...
    @RequestWrapper(localName = "Translator", targetNamespace = "http://WebXml.com.cn/", className = "cn.qdgxy.trans.Translator")
    @ResponseWrapper(localName = "TranslatorResponse", targetNamespace = "http://WebXml.com.cn/", className = "cn.qdgxy.trans.TranslatorResponse")
    public cn.qdgxy.trans.TranslatorResponse.TranslatorResult translator(
     ...
     *
     * @param wordKey
     * @return returns cn.qdgxy.trans.ArrayOfString
     */
    ...
    @RequestWrapper(localName = "TranslatorString", targetNamespace = "http://WebXml.com.cn/", className = "cn.qdgxy.trans.TranslatorString")
    @ResponseWrapper(localName = "TranslatorStringResponse", targetNamespace = "http://WebXml.com.cn/", className = "cn.qdgxy.trans.TranslatorStringResponse")
    ...
    @RequestWrapper(localName = "TranslatorReferString", targetNamespace = "http://WebXml.com.cn/", className = "cn.qdgxy.trans.TranslatorReferString")
    @ResponseWrapper(localName = "TranslatorReferStringResponse", targetNamespace = "http://WebXml.com.cn/", className = "cn.qdgxy.trans.TranslatorReferStringResponse")
    ...
    @RequestWrapper(localName = "TranslatorSentenceString", targetNamespace = "http://WebXml.com.cn/", className = "cn.qdgxy.trans.TranslatorSentenceString")
    @ResponseWrapper(localName = "TranslatorSentenceStringResponse", targetNamespace = "http://WebXml.com.cn/", className = "cn.qdgxy.trans.TranslatorSentenceStringResponse")
    ...
    @RequestWrapper(localName = "SuggestWord", targetNamespace = "http://WebXml.com.cn/", className = "cn.qdgxy.trans.SuggestWord")
    @ResponseWrapper(localName = "SuggestWordResponse", targetNamespace = "http://WebXml.com.cn/", className = "cn.qdgxy.trans.SuggestWordResponse")
    ...
    @RequestWrapper(localName = "GetMp3", targetNamespace = "http://WebXml.com.cn/", className = "cn.qdgxy.trans.GetMp3")
    @ResponseWrapper(localName = "GetMp3Response", targetNamespace = "http://WebXml.com.cn/", className = "cn.qdgxy.trans.GetMp3Response")
    public byte[] getMp3(
