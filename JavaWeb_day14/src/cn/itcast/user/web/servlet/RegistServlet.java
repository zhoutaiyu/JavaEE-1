...
public class RegistServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		if (username == null || username.trim().isEmpty()) {
			...
			errors.put("username", "用户名的长度必须在6~20之间！");
		}
		// 对密码进行校验
		...
		if (password == null || password.trim().isEmpty()) {
			...
			errors.put("password", "密码的长度必须在6~20之间！");
		}
		// 对验证码进行校验
		...
		/*
		 * 2. 调用userService的rigist()方法，传递form过去
		 * 3. 得到异常：获取异常信息，保存到request域中，转发到regist.jsp显示
		 * 4. 没有异常：输出注册成功！
		 */
		try {
