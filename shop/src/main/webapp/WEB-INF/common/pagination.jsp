...
<div class="pagination">
	...
	<s:if test="pageBean.pageNumber > 1">
		<%-- 【上一页】 --%>
		<a href="<s:property value='pageBean.url' />&pageNumber=<s:property value='pageBean.pageNumber-1' />">&lt;&lt;</a>
	</s:if>
	...
	<s:iterator var="i" begin="#begin" end="#end">
		...
		<s:else>
			<!-- 【其他页码】 -->
			<a href="<s:property value='pageBean.url' />&pageNumber=<s:property value='#i' />" ><s:property value='#i' /></a> 
		</s:else>
	</s:iterator>
