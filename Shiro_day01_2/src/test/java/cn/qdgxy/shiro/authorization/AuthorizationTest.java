package cn.qdgxy.shiro.authorization;
...
public class AuthorizationTest {
    ...
    public void testAuthorization() {
        ...
        System.out.println("单个角色(role1)判断" + ishasRole);
        // hasAllRoles是否拥有多个角色
        boolean hasAllRoles = subject.hasAllRoles(Arrays.asList("role1", "role2", "role3"));
        System.out.println("多个角色(role1、role2、role3)判断" + hasAllRoles);
        ...
        System.out.println("单个权限判断(user:create:1)" + isPermitted);
